...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _single_post_single_post_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./single-post/single-post.component */
    "./src/app/single-post/single-post.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_5__["HomeComponent"], _about_about_component__WEBPACK_IMPORTED_MODULE_6__["AboutComponent"], _navbar_navbar_component__WEBPACK_IMPORTED_MODULE_7__["NavbarComponent"], _notfound_notfound_component__WEBPACK_IMPORTED_MODULE_8__["NotfoundComponent"], _contacts_contacts_component__WEBPACK_IMPORTED_MODULE_9__["ContactsComponent"], _footer_footer_component__WEBPACK_IMPORTED_MODULE_10__["FooterComponent"], _test_test_component__WEBPACK_IMPORTED_MODULE_12__["TestComponent"], _single_post_single_post_component__WEBPACK_IMPORTED_MODULE_13__["SinglePostComponent"]],
  ...
  /***/
  function srcAppContactsContactsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppContactsContactsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ContactsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/contacts/contacts.component.scss")).default]
    })], ContactsComponent);
    /***/
  },
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function HomeComponent(_api) {
        ...
        _api.getPHOTOS().subscribe(function (data) {
          _this.photos = data;
          console.log(data);
        });

        _api.getPOSTS().subscribe(function (data) {
          return _this.posts = data;
        });

        _api.getCOMMENTS().subscribe(function (data) {
          _this.comments = data;
        });

        _api.getUSERS().subscribe(function (data) {
  ...
  function srcAppNotfoundNotfoundComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    NotfoundComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/notfound/notfound.component.scss")).default]
    })], NotfoundComponent);
    /***/
  },
  ...
  /***/
  function srcAppSinglePostSinglePostComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppSinglePostSinglePostComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function SinglePostComponent(_api, _activeRoute) {
        var _this2 = this;
        ...
        _api.getPHOTOS().subscribe(function (data) {
          return _this2.photos = data[_this2.postID - 1];
        });

        _api.getPOSTS().subscribe(function (data) {
          return _this2.post = data[_this2.postID - 1];
        });

        _api.getCOMMENTS().subscribe(function (data) {
          _this2.comments = data;

          for (var i = 0; i < _this2.comments.length; i++) {
            if (_this2.comments[i].postId == _this2.postID) {
              _this2.commentsOfPost.push(_this2.comments[i].body);
            }
          }
        });

        _api.getUSERS().subscribe(function (data) {
          return _this2.user = data[_this2.postID - 1];
        });
      }
    ...
    SinglePostComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./single-post.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/single-post/single-post.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./single-post.component.scss */
      "./src/app/single-post/single-post.component.scss")).default]
    })], SinglePostComponent);
    /***/
  },
